...
\section{Objetivos}
El objetivo de esta experiencia laborativa es desarrollar e implementar una arquitectura de software multitarea utilizando el sistema operativo en tiempo real \textbf{FreeRTOS} sobre el framework \textbf{ESP-IDF}. Se tiene por propósito tratar y resolver problemas de concurrencia, comunicación entre tareas y protección de recursos compartidos mediante la aplicación práctica de:
\begin{itemize}
...
Conclusiones técnicas sobre el comportamiento del sistema multitarea, las dificultades encontradas al migrar o trabajar en ESP-IDF v6 (como la inclusión explícita de cabeceras de FreeRTOS) y el aprendizaje adquirido sobre sistemas de tiempo real.
